...
```javascript
INT32_MIN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-int32-min@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-int32-min@umd/bundle.js"></script>
```
